        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <img class="first-slide" src="css/images/carousel_sports_cricket.jpg" alt="First slide">
              <div class="container">
                <div class="carousel-caption">
                  <h1>Cric,cric,cricket;Don't throw your wicket</h1>
                  <p>Play your game and built your legacy!</p>
                </div>
              </div>
            </div>
            <div class="item">
              <img class="second-slide" src="css/images/carousel_sports_soccer3.jpg">
              <div class="container">
                <div class="carousel-caption">
                  <h1>Go after your goals</h1>
                  <p>The whistle has blown, so get your feet up and play the ball</p>
                  </div>
              </div>
            </div>
            <div class="item">
              <img class="third-slide" src="css/images/carousel_sports_chess.jpg">
              <div class="container">
                <div class="carousel-caption">
                  <h1>King of Chess</h1>
                  <p>Be the grandmaster and conquer the board with your skills</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container " id="events-container">
           ...
           <?php
               ...
               session_start();
                ...
                $sql = "SELECT event_id,event_name FROM event WHERE event_category='sports' ";
