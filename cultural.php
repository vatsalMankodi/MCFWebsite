        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <img class="first-slide" src="css/images/carousel_cultural_dance.jpg" alt="First slide">
              <div class="container">
                <div class="carousel-caption">
                  <h1>Let's Dance!</h1>
                  <p>Move your feet in the ultimate dance battle and show the city your talent</p>
                </div>
              </div>
            </div>
            <div class="item">
              <img class="second-slide" src="css/images/carousel_cultural_art.jpg">
              <div class="container">
                <div class="carousel-caption">
                  <h1>A Picasso in the making</h1>
                  <p>Portray your art form in the fields of design, painting and drawing</p>
                  </div>
              </div>
            </div>
            <div class="item">
              <img class="third-slide" src="css/images/carousel_cultural_music.jpg">
              <div class="container">
                <div class="carousel-caption">
                  <h1>The Sound Of Music </h1>
                  <p>Get ready to tune your voice to the right pitch and rhythm</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container " id="events-container">
           ...
           <?php
               ...
               session_start();
                ...
                $sql = "SELECT event_id,event_name FROM event WHERE event_category='cultural' ";
                 ...
                 $.ajax({
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response==-1)
                                $("#register-section").html(" </div><div id='buttonHere'> Log In to Register! </div>");        
                            else if(response==0)
                                $("#register-section").html(" </div><div id='buttonHere'> <button type=button class='btn btn-primary' onclick='register()' > Register Now! </button> </div>");    
                            else if(response==1)
                                $("#register-section").html(" </div><div id='buttonHere'> Already Registered! </div>");        
